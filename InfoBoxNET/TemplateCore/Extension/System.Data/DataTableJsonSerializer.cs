        ...
        public static void Save(DataTable table, string fileName)
        {
            ...
            foreach (DataColumn column in table.Columns)
            {
                var columnJson = new DataColumnJson
                {
                    ...
                    Type = column.DataType.AssemblyQualifiedName!,
                    ...
                    ExtendedProperties = SerializeProperties(column.ExtendedProperties),
                    DefaultValue = SerializeDefaultValue(column.DefaultValue)
                };
